...
- [Hypervisor setup and operation-cycle](hypervisor-setup-and-operation-cycle/README.md)
  ...
  - [(5) Handle: The hypervisor typically emulates the event and does (4), repeating the process](hypervisor-setup-and-operation-cycle/5-handle-the-hypervisor-typically-emulates-the-event-and-does-4-repeating-the-process.md)
